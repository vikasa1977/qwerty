...
(function (factory) {
    ...
    var displayKey, filterKeys, optionFormat;
    ...
    function Autocomplete(el, options) {
            ...
            defaults = {
                ...
                lookupFilter: function (suggestion, originalQuery, queryLowerCase) {
                    ...
                    for(var i=0; i<filterKeys.length; i++) {
                        str = str + suggestion[filterKeys[i]].toLowerCase().trim() + ' ';
                    }
                    str = str.trim();
        ...
        optionFormat = that.optionFormat;
    ...
    Autocomplete.formatResult = function (suggestion, currentValue) {
        ...
        return suggestion[suggestion.hasOwnProperty(displayKey)?displayKey:'value']
    ...
    Autocomplete.prototype = {
        ...
        isExactMatch: function (query) {
            ...
            var isFound = false;
            for(var i=0; i<filterKeys.length; i++) {
                if(suggestions[0].hasOwnProperty(filterKeys[i]) && suggestions[0][filterKeys[i]].toLowerCase() === query.toLowerCase()) {
                    isFound = true;
                    break;
                }
            }
            return (suggestions.length === 1 && isFound);
        },
