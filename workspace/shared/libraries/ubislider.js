...
var UbiSlider = {
        ...
        var d = function () {
            ...
            r = function () {
                s.item.find(".ubislider-inner li").on("click", function () {
                    n($(this)), $('li.active').removeClass('active');
            ...
            l = function (i) {
                ...
                var e = i.attr("data-image"),
                    t = "<div class='ubiModal'><div class='ubi-close waves-circle waves-effect btn-flat'><i class='icon iconSmall grey-text'><svg><use xlink:href='#icon_Close'></use></svg></i></div><div class='ubi-arrows left icon iconSmall white-text waves-circle waves-effect waves-light' smart-tooltip position='bottom' delay='10' message='Previous'><svg><use xlink:href='#icon_Previous'></use></svg></div><div class='ubi-arrows right icon iconSmall white-text waves-circle waves-effect waves-light'> <svg><use xlink:href='#icon_Next'></use></svg></div><div class='ubi-main-image' data-slide='" + e + "'><ul class='ubi-main-slide'>" + s.item.find(".ubislider-inner").html() + "</ul></div><ul class='ubi-thumbs'>" + s.item.find(".ubislider-inner").html();
                $("body").append(t);
                var a = "-" + $(".ubi-main-image").width() * e + "px";
                $(".ubi-main-slide").width($(".ubi-main-image").width() * $(".ubi-main-slide li").length), $(".ubi-main-slide").css("left", a), $(".ubi-main-slide li").width($(".ubi-main-image").width())
                if (e == "0") { $(".ubi-arrows.left").addClass("pasive") }
                else if ($('.ubi-main-slide li').length - 1 == e) { $(".ubi-arrows.right").addClass("pasive") }
            },
            o = function (i) {
                var e = i.index(),
                    lc = $(".ubi-main-slide li").length - 1,
                ...
                if (e == "0") { $(".ubi-arrows.left").addClass("pasive") }
                else { $(".ubi-arrows.left").removeClass("pasive") }

                if (lc == e) { $(".ubi-arrows.right").addClass("pasive") }
                else { $(".ubi-arrows.right").removeClass("pasive") }
            ...
            c = function () {
                $(".ubiModal .ubi-close").bind("click", function () {
                    ...
                    i.stopPropagation(), o($(this)), $('li.active').removeClass('active');
                    $(this).addClass('active');
                })
    ...
    slideToLeftOrRight: function (i, e) {
       ...
       if (0 == s && 0 == i.closest("li").index()) {
           t = 0;
        } else {
	        if (s == n * e.item.find("li").outerWidth(!0) && i.closest("li").index() == d) {
	            t = 2;
	        } else {
		        if (i.closest("li").index() == r) {
			        (t++, e.item.attr("data-slideTime", t), e.item.find(".ubislider-inner").css("left", "-" + e.item.find("li").outerWidth(!0) * t + "px"))
		        } else {
			        i.closest("li").index() == l && (t--, e.item.attr("data-slideTime", t), e.item.find(".ubislider-inner").css("left", "-" + e.item.find("li").outerWidth(!0) * t + "px"))
		        }
	        }
        }
    },
