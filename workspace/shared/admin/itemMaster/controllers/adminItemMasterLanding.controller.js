angular.module('SMART2')
    ...
    .controller('adminItemMasterLandingCtrl', ['$scope', '$rootScope', '$translate', 'RuleEngine', '$http', '$state', 'notification', '$timeout', '$filter', '$sce', adminItemMasterLandingCtrlFunc])
...
function adminItemMasterLandingCtrlFunc($scope, $rootScope, $translate, RuleEngine, $http, $state, notification, $timeout, $filter, $sce) {

    $scope.submitRfx = function () {
        var confi = {
            type: "success",
            message: "<p class='left-align'>RFx has been created successfully.</p>",
    ...
    $scope.itemConfig = [
        {
            ...
            "type": "editable",
            "cellTemplate": "<a ui-sref='mdm.new'>{{ row.entity.PartNumber }}</a>",
        },
        {
            "field": "PartName",
            "width": 150,
        ...
        },
        {
            ...
            "width": 180,
            "displayName": "Parent Part Number",
            "isVisible": true,
            "filterObject": {
                "enableFiltering": true
            },
    ...
    $scope.itemModel = [
        {
            "PartNumber": "P678 053 3116",
            "PartName": "Fuel Hose and Tube Assy",
        ...
        {
            "PartNumber": "P692 425 3173",
            "enableCellEdit": false,
            "spLink": 12002,
            "PartName": "Actuator Assy",
        ...
        {
            "PartNumber": "P537 925 5356",
            "PartName": "Bolt, Flange 14x96",
            "description": "Bolt, Flange 14x96",
            "category":"Flange Bolts",
            "partType": "Raw Material",
            "baseUom":  "EA",
            "parentPartNumber": "P686 763 7869",
            "machineTool": "Yes",
            "status": "Production",
            "targetPrice": "39.92",
            "Currency": "SEK",
        ...
        {
            "PartNumber":"P544 754 2864",
            "PartName": "Eye Bolt M24",
            "description": "Eye Bolt M24",
            "category":"Eye Bolts",
            "partType": "Raw Material",
            "baseUom":  "PK",
            "parentPartNumber": "P691 292 7885",
            "machineTool": "Yes",
            "status": "Production",
            "targetPrice": "24.09",
            "Currency": "USD",
        ...
        {
            "PartNumber":"P608 291 1559",
            "PartName": "Clip Assy, Trip 8mm",
            "description": "Clip Assy, Trip 8mm",
            "category":"Clips",
            "partType": "Assembly",
            "baseUom":  "EA",
            "parentPartNumber": "-",
        ...
        {
            "PartNumber": "P582 946 2671",
            "PartName": "Bolt 7/16 X 17.6",
            "description": "Bolt 7/16 X 17.6",
            "category":"Bolts",
            "partType": "Raw Material",
            "baseUom":  "PK",
            "parentPartNumber": "P624 318 1407",
            "machineTool": "Yes",
            "status": "Production",
            "targetPrice": "109.19",
            "Currency": "SEK",
        ...
        {
            "PartNumber": "P517 379 0922",
            "PartName": "Cam Plate M14",
            "description": "Cam Plate M14",
            "category":"Cam Plates",
            "partType": "Raw Material",
            "baseUom":  "EA",
            "parentPartNumber": "P657 690 4813",
            "machineTool": "Yes",
            "status": "Production",
            "targetPrice": "327.21",
            "Currency": "SEK",
        ...
        {
            "PartNumber": "P525 871 0119",
            "PartName": "Band, Hose D70",
            "description": "Band, Hose D70",
            "category":"Hose Band",
            "partType": "Raw Material",
            "baseUom":  "EA",
            "parentPartNumber": "P674 952 1003",
            "machineTool": "Yes",
            "status": "Production",
            "targetPrice": "155.64",
            "Currency": "SEK",
        ...
        {
            "PartNumber":"P520 050 1992",
            "PartName": "Seal, Hole 45x45",
            "description": "Seal, Hole 45x45",
            "category":"Hole Seals",
            "partType": "Raw Material",
            "baseUom":  "EA",
            "parentPartNumber": "P694 950 0889",
            "machineTool": "Yes",
            "status": "Production",
            "targetPrice": "2.94",
            "Currency": "USD",
        ...
        {
            "PartNumber":"P691 169 7676",
            "PartName": "Sensor assy, battery",
            "description": "Sensor assy, battery",
            "category":"Sensors",
            "partType": "Assembly",
            "baseUom":  "EA",
            "parentPartNumber": "-",
