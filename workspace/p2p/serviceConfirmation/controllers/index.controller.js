angular.module('SMART2')
    .controller('p2pServiceConfCtrl', ['$scope', '$state', '$rootScope', 'RuleEngine', '$http', p2pServiceConfCtrlFunc])
	.controller('shipToCtrl', ['$scope', '$rootScope', shipToCtrlFunc])
    .controller('billToCtrl', ['$scope', '$rootScope', billToCtrlFunc]);

function p2pServiceConfCtrlFunc($scope, $state, $rootScope, RuleEngine, $http) {
        	...
        	if ($state.params.statefrom == 'buyerLoginSC' || $state.params.mode == 'supplierInvoice') {
        	    req.url = 'p2p/serviceConfirmation/models/NewcreateServiceConfirmationBuyer.json'
        	}
        	if ($state.params.mode == 'supplier') {
        	    req.url = 'p2p/serviceConfirmation/models/NewcreateServiceConfirmation.json'
        	}
