   ...
   $scope.onChange = function(selectedCurrency) {
	...
	if($state.params.status === "readonly"){
        ...
        if(!$state.productNameKetchup && !$state.productNameFoldingCartons &&!$state.productNameMilk && !$state.productNameAcrylonitrile && !$state.productNameFuleHouse && !$state.productNamePretzelAnalysis && !$state.productNamepolyviny) {
            ...
            $scope.docName = "Fuel Hose & Tube Assembly Analysis";
            var urlJson = 'mdm/models/fuelHouseDetails.json';
        }
        else if($state.productNamePretzelAnalysis) {
            $scope.docName = "Pretzel Analysis";
            var urlJson = 'mdm/models/pretzelAnalysisDetails.json';
        }
    ...
    $state.viewScenario = false;
    $scope.manageFieldsPopupCallback = function() {
        $state.go('compare');
    }

    $scope.createScenario = function() {
        $state.viewScenario = true;
