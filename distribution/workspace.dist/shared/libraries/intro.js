  ...
  function _setShowElement(targetElement) {
    ...
    if (targetElement.element instanceof SVGElement) {
      ...
      while (targetElement.element.parentNode != null) {
		...
		if(targetElement.showElementAfterAnimation)
		{
			$(".introjs-helperLayer").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function(){
				_setClass(targetElement.element, 'introjs-showElement');
				if(targetElement.callback)
					targetElement.callback();
				$(".introjs-helperLayer").off("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd");
			});
		}
		else
		{
